...
//
//	static void StoreVertexLocation(std::queue<std::string>& vertexSegments, std::vector<glm::vec3>& positionDest);
//	static void StoreTextureCoordinate(std::queue<std::string>& textureCoordinateSegments, std::vector<glm::vec2>& textureCoorDest);
//	static void StoreVertexNormal(std::queue<std::string>& vertexNormalSegments, std::vector<glm::vec3>& normalsDest);
