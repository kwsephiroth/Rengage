...
namespace rengage
{
	...
	{
	public:
		RenderingWindow(std::shared_ptr<OGLInvoker> ogl_invoker, std::shared_ptr<services::logging::ILogger> logger, WindowAttributes attributes = DEFAULT_WINDOW_ATTRIBS, bool full_screen = false);
		~RenderingWindow();
